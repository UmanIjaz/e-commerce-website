...
function CartBox({ cart, setCart, removeFromCart, onConfirmOrder }) {
  return (
    <section
      id="CartBox"
      className="h-full w-full max-w-[350px] rounded-md bg-white p-4"
    >
      {cart.length > 0 ? (
        <>
          ...
          <div className="space-y-5">
            ...
            <span className="flex justify-center text-center">
              <p className="text-matblac rounded-md bg-bgcolor px-6 py-4">
            ...
            <button
              ...
              className="w-full cursor-pointer rounded-full bg-primary px-6 py-2 font-semibold text-white hover:bg-primaryhover"
            >
              Confirm Order
            </button>
          </div>{" "}
